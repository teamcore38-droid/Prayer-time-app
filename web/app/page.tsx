...
export default function LandingPage() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col font-sans transition-colors duration-300">
      ...
      {/* Hero Section */}
      <section className="relative py-14 md:py-32 overflow-hidden border-b border-slate-200 dark:border-slate-900">
        {/* Glow gradients */}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center relative z-10">
          ...
          <div className="space-y-6 md:space-y-8 text-center lg:text-left">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tight leading-tight md:leading-none text-slate-900 dark:text-white">
              Connect your{' '}
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <Link
                href="/register"
                className="w-full sm:w-auto px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm rounded-xl transition-all shadow-lg shadow-emerald-900/20 flex items-center justify-center gap-2 group"
              >
              ...
              <a
                href="#download"
                className="w-full sm:w-auto px-6 py-3 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-900 font-bold text-sm rounded-xl transition-all flex items-center justify-center gap-2"
              >
          ...
          <div className="relative flex justify-center">
            ...
            <div className="w-64 sm:w-72 h-[440px] sm:h-[500px] max-w-full border border-slate-200 dark:border-slate-800 rounded-[40px] bg-slate-950 p-3 shadow-2xl relative">
      ...
      <section className="py-14 md:py-20 max-w-7xl mx-auto px-6 md:px-8 space-y-10 md:space-y-12">
      ...
      {/* Download Block */}
      <section id="download" className="py-12 md:py-16 bg-gradient-to-br from-slate-900 to-slate-950 border-t border-slate-800 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-8 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap w-full md:w-auto justify-center gap-3 sm:gap-4">
            <button className="w-full sm:w-auto px-5 py-3 sm:py-2.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl text-xs font-bold transition-all">
      ...
      <footer className="py-8 bg-slate-100 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-900 mt-auto text-xs text-center text-slate-500">
        <p>&copy; 2026 Masjid Connect. All rights reserved.</p>
      </footer>
